...
export const BorrowInput = (props: {
  ...
  const { accounts: sourceAccounts, balance, balanceLamports } = useUserBalance(
    props.reserve.info.liquidity.mintPubkey,
  );

  console.log(sourceAccounts.length)
  ...
  console.log('Current Obligation: ' + obligation);
  ...
  const onBorrow = useCallback(() => {
    ...
    (async () => {
      try {
        ...
        const liquidityAmount = Math.ceil(
          balanceLamports * (parseFloat(value) / balance),
        );
