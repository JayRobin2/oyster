...
import { ObligationLiquidity, ObligationCollateral } from '../models';
        ...
        return (
          item.obligation.info.borrows.some(
            (liquidity: ObligationLiquidity) =>
              liquidity.borrowReserve.toBase58() === borrowReservePubkey,
          ) &&
          item.obligation.info.deposits.some(
            (collateral: ObligationCollateral) =>
              collateral.depositReserve.toBase58() === depositReservePubkey,
          )
        );
      }
